...
os.system('xdg-open https://www.facebook.com/profile.php?id=61556947617535')
def logo():
    os.system('clear')
    print(f"""                   {green}┏━━━━━━━━━━━━━━━━━━━┓{green}
                   {green}┃{white}{faltu}SHEIKH SAJIB{pvt}{green}┃
{green}╔━━━━━━━━━━━━━━━━━━┻━━━━━━━━━━━━━┳━━━━━┻━━━━━━━━━━━━━━━━━━━╗
{green}┃{green}╔╦╗{green}╔═╗{rad}╦ ╦{yellow}╔═╗{cyan}╔╦╗{yelloww}╦ {rad}╔═╗╔═╗╔═╗╔═╗╔╦╗{green}┃{purple}CEO {yelloww}: {yellow}SAJIB-PAPIYA{green}┃
{green}┃{green}║║║{green}╠═╣{rad}╠═╣{yellow}╠═╣{cyan} ║║{yelloww}║{yellow}X{white}╚═╗║╣ ╠╣ ╠═╣ ║{green} ┃{purple}CEO {yelloww}: {green}  Sheikh SAJIB       {green}┃
{green}┃{white}╩ ╩{green}╩ ╩{rad}╩ ╩{yellow}╩ ╩{cyan}═╩╝{yelloww}╩ {rad}╚═╝╚═╝╚  ╩ ╩ ╩ {green}┃{purple}GIT {yelloww}: {cyan}PAPIYA-SAJIB       {green}┃
{green}┣━━━━━━━━━━━━━━━━━━┳━━━━━━━━━━━━━┻━━━━━━┳━━━━━━━━━━━━━━━━━━┫
{green}┃ {green}TOOL : {yelloww}BD RANDOM {green}{green}┃ {green}WP {yelloww}: {blue}+8801984254741{green}┃  {yelloww}VERSION {green}: {rad}0.2  {green}┃
{green}╚━━━━━━━━━━━━━━━━━━┻━━━━━━━━━━━━━━━━━━━━┻━━━━━━━━━━━━━━━━━━╝""")
...
def mahadi():
    ...
    if _____mahadi_____ in ['A','a','01','1']:
        ...
        os.system('xdg-open https://www.facebook.com/SAJIB.143')
    elif _____mahadi_____ in ['C','c','03','3']:
        os.system('xdg-open https://m.me/j/SAJIB_VtYZ3YtOpBX/')
...
def ___uids___():
    ...
    os.system('mpv /storage/emulated/0/Download/123.mp3')
    limit = int(input(f"{white}[{green}+{white}] LIMIT       {green}: {white}"))
    for nmbr in range(limit):
        nmp = ''.join(random.choice(string.digits) for _ in range(8))
        user.append(nmp)
    with tred(max_workers=30) as PAPIYASAJIB:
        os.system('clear')
        logo()
        tl = str(len(user))
